...
# select variables
notifications_raw <- dplyr::select(notifications_raw, key_ID, member_state, notification_number, start_date, start_year, start_month, start_day, end_date, end_year, end_month, end_day)
